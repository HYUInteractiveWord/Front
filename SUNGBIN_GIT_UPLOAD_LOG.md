...
## 현재 반영 사항
- AWS 배포 테스트용 API 주소를 `3.39.234.68:8000`으로 교체
- Android cleartext 허용 도메인에 `3.39.234.68` 추가
